  ...
  const fetchSheetData = useCallback(async () => {
    try {
      ...
      rows.forEach((row, rowIndex) => {
        ...
        const isUserMatch = (currentUserRole === "admin" || currentUserRole === "main admin") || assignedTo.toLowerCase() === currentUsername.toLowerCase()
        ...
        // For history, include ALL completed tasks regardless of Column P status
          ...
          const isUserHistoryMatch =
            (currentUserRole === "admin" || currentUserRole === "main admin") || assignedTo.toLowerCase() === currentUsername.toLowerCase()
      ...
      <div className="space-y-6">
        <div className="flex flex-col justify-between gap-4 sm:flex-row sm:items-center">
          ...
          <div className="flex space-x-4">
            ...
            {showHistory && (userRole === "admin" || userRole === "main admin") && selectedHistoryItems.length > 0 && (
        ...
        <div className="rounded-lg border border-purple-200 shadow-md bg-white overflow-hidden">
          <div className="bg-gradient-to-r from-purple-50 to-pink-50 border-b border-purple-100 p-4">
            ...
            <p className="text-purple-600 text-sm">
              {showHistory
                ? `${CONFIG.PAGE_CONFIG.historyDescription} for ${(userRole === "admin" || userRole === "main admin") ? "all" : "your"} tasks`
